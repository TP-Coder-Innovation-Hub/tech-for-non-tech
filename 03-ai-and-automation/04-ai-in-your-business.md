...
1. Identify one repetitive process that consumes significant time or money.
2. Verify that quality data exists for that process.
3. Define clear success metrics before starting.
4. Run a pilot with a small scope.
5. Measure results against the baseline.
6. Expand only if the pilot delivers.
